// Date: 7 April 2020
// ref: https://docs.oracle.com/cd/E19205-01/820-0619/geosb/index.html

// compile: gcc din_philo_fix1.c -pthread -o din_philo_fix1
// Ignore any warnings if found ...
...
void grab_chopstick (int,
  ...
  void down_chopsticks (int,
    ...
    int sleep_seconds = 0;
    u_int32_t num_can_eat = PHILOS - 1;
